...
IUSE="acl addc addns ads client cluster cups dmapi fam gnutls gpg iprint
...
multilib_src_configure() {
	...
	myconf=(
		...
		--bundled-libraries=$(usex system-mitkrb5 "NONE" "heimdal,!tdb,!talloc,!pytalloc-util,!tevent,!popt,!ldb,!pyldb-util,!zlib")
