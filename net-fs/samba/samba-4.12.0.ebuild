...
inherit python-single-r1 waf-utils multilib-minimal linux-info systemd pam git-r3
fi
...
if [[ ${PV} != 9999* ]] ; then
	...
	PATCHES=(
		...
		"${FILESDIR}/samba-mr1062.patch"
	)
else
	EGIT_REPO_URI="https://git.samba.org/samba.git"
#	EGIT_OVERRIDE_REPO_SAMBA
	EGIT_OVERRIDE_BRANCH_SAMBA=master
	EGIT_OVERRIDE_COMMIT_SAMBA="4edece5e973ac22ce735be3ca2944147d26bdb5d"
#	EGIT_OVERRIDE_COMMIT_DATE_SAMBA
...
CDEPEND="
	...
	<sys-libs/ldb-2.2.1[ldap(+)?,python?,${PYTHON_SINGLE_USEDEP},${MULTILIB_USEDEP}]
	sys-libs/libcap
	...
	system-mitkrb5? ( >=app-crypt/mit-krb5-1.18[${MULTILIB_USEDEP}] )
